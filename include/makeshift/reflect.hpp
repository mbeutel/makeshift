...
template <typename T>
constexpr bool
have_values_of_v = have_values_of<T>::value;
    ...
    //
template <typename T>
constexpr detail::values_of_r<T>
values_of = detail::values_of_<T>{ }();
